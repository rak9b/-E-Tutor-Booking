...
const AboutUs = () => {
  return (
    <>
      <Helmet>
        <title>About Us | Online Tutor Booking</title>
      </Helmet>
          ...
          <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                We are a team of passionate educators and technologists
                dedicated to making quality education accessible to everyone.
                Our online tutor platform connects students with highly skilled
                tutors from around the world, ensuring personalized learning
                experiences.
              </p>
              <Link
                to="/contact"
          ...
          <div className="w-11/12 mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              >
                ...
                <p className="text-gray-600">
                  We embrace technology and innovation to create a better
